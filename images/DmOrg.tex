...
\usepackage[paperwidth=31cm,paperheight=21cm,
...
\newcommand\dmnode[5][]{
            \node (#2) [mbox, text width=36mm, rectangle split, rectangle split parts=2, #1]
             ...
             \node({#2}s) [psbox,minimum height=9mm, below=2pt of {#2}t, text width=32mm] {{\small \bf Product Owner}\\\strut#5};
        }
...
\begin{tikzpicture}[node distance=0mm]
    ...
    \node (dm) [arcbox, align=left, text width=30cm,  minimum height=10mm, rectangle split, rectangle split parts=2]
	{ \hspace{0.1cm} \textbf{Data Management Subsystem}
	   \nodepart{second} \vspace{150mm} 
	};
    ...
    \node (pdocu) [mbox, right=3.5cm of ps, text width=35mm, minimum height=12mm] {\textbf{LSST Documentalist}\\ Robert McKercher};

    \node (udmpm) [below=39mm of dmpm, text width=0mm]{};
    \node (udmpm1) [below=18mm of dmpm, text width=0mm]{};
    \node (udmpm2) [below=100mm of dmpm, text width=0mm]{};
...
% SYSENG
    ...
    \node (syseng) [mbox, below=1mm of pipe, text width=39mm] {\textbf{ Systems Engineer}\\ Tim Jenness };
    ...
    \node (reqeng) [pobox, below=1mm of sysarc, text width=39mm] {\textbf{Interface Scientist}\\ Gregory Dubois-Felsmann  };
%%%% end SYSENG
    ...
    \node (docu) [mbox, below=5mm of pcon, text width=45mm] {\textbf{DM Documentalist}\\ Jonathan Sick };
    \node (admin) [mbox, below=5mm of docu, text width=45mm] {\textbf{DM Admin}\\ Libby Petrick};


    %\node (al) [below=69mm of dmpm, text width=0mm]{};
    \dmnode[left=1mm of udmpm2.north]{suit}{SUIT}{Xiuqin Wu}{Gregory Dubois-Felsmann} ;
    \dmnode[base left=2mm of suit]{das}{Data Access Services}{Fritz Mueller}{Mario Juric}
    ...
    \dmnode[base right=2mm of suit]{square}{SQuaRE} {\strut Frossie Economou}{ Simon Krughoff } ;
    ...
    \dmnode[base right=2mm of infra]{lhn}{LHN \& Base Site}{Jeff Kantor}{Mario Juric} ;
