...
\usepackage[paperwidth=30cm,paperheight=21cm,
...
%%%% end SYSENG
    ...
    \node (pdocu) [mbox, right=4.5cm of ps, text width=45mm, minimum height=12mm] {\textbf{LSST Documentalist}\\ Robert McKercher};
    ...
    \dmnode[base left=2mm of suit]{das}{Data Access Services}{Fritz Mueller}{Mario Juric} {psbox};
 ...
 %% GROUPS ..
    ...
    \node (tct) [mbox, left=1cm of syseng.west , text width=25mm] {\textbf{DMCCB (was TCT) }};
