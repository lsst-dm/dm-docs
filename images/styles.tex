...
\tikzstyle{docboxm}=[rectangle, rounded corners=3pt, draw=black, fill=yellow!50!white, 
 very thick, minimum height=12mm, inner sep=2pt,  text centered, text width=30mm]

\tikzstyle{docboxu}=[rectangle, rounded corners=3pt, draw=black, fill=orange!50!white, 
 very thick, minimum height=12mm, inner sep=2pt,  text centered, text width=30mm]
...
\tikzstyle{dlines}=[-, thick, cyan]
\tikzstyle{tline}=[->, thick, dashed, blue]
\tikzstyle{tlines}=[-, thick, dashed, blue]
